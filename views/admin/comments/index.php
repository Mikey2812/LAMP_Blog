...
<?php vendor_html_helper::contentheader('Comments <small>management</small>', [['urlp'=>['ctl'=>$app['ctl'], 'act'=>$app['act']]]]); ?>
        ...
        <div class="card card-default color-palette-box">
            <div class="card-header" id="records-header">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-xs-4 dataTables_wrapper">
                        <form method="get"
                            action="<?php echo (vendor_app_util::url(["ctl"=>"comments", "act"=>"filter"])) ?>"
                    ...
                    <div class="col-sm-2 col-xs-4">
                        ...
                        <a href="<?php echo vendor_app_util::url(['ctl'=>'comments','act'=>'add']); ?>" id="add-record"
            ...
            <div class="card-body">
                <div id="table_wrapper" class="dataTables_wrapper dt-bootstrap4">
                    <div class="row">
                        <div class="col-sm-12">
                            <table controller="comments" class="table table-bordered table-striped dataTable"
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="tabletShow" style="width: 12%;">Number Like</th>
                                        <th style="width: 8%;">Status</th>
                                        <th class="webShow" style="width: 5%;">type</th>
                                        <th style="width: 15%;">Action</th>
                                    </tr>
                                </thead>
                                <tbody id="tbody-comments" class="records">
                                    ...
                                    <tr role="row" id="row<?=$record['id'];?>">
                                        ...
                                        <td id="<?php echo("fullname".$record['id']);?>">
                                            <a href="<?php echo (vendor_app_util::url(["ctl"=>"comments", "act"=>"view/".$record['id']])) ?>"
                                        ...
                                        <td class="tabletShow" id="<?php echo("number_like".$record['id']);?>">
                                            <a href="<?php echo (vendor_app_util::url(["ctl"=>"comments", "act"=>"view/".$record['id']])) ?>"
                                                id="viewUserRequest<?=$record['id'];?>"><?php echo $record['number_like']; ?>
                                            </a>
                                        </td>
                                        <td class="tabletShow" id="<?php echo("type".$record['id']);?>">
                                            <?php echo $record['type']; ?>
                                        </td>
                                        <td class="btn-act" class="tabletShow"
                                            id="<?php echo("status".$record['id']);?>">
                                            <span
                                                class="<?php echo $record['status'] == 1?'badge badge-success':'badge badge-danger'?>">
                                                <?php echo $app['status'][$record['status']];?></span>
                                        </td>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th class="tabletShow" style="width: 10%;">number_like</th>
                                        <th class="webShow" style="width: 5%;">type</th>
                                        <th style="width: 15%;">Action</th>
                                    </tr>
                                </tfoot>
